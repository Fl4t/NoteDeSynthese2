...
d’éviter que le travail d’une de ces personnes ne soit écrasé. La
figure~\ref{flow} qui ce trouve en page \pageref{flow} illustre
basiquement l'utilisation de Git.
