...
par Windows.} qui explore tous les dossiers englobant
les sources des dépôts et les met à jour. Pour cela j'ai parcouru la
documentation de la console Windows et ça n'a pas été
...
machine virtuelle Windows\, \footnote{À partir du
